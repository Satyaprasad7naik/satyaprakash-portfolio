        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Build and optimize paid acquisition systems from targeting and
                creative testing to landing page optimization and weekly
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Attribution</div>
                <div className="what-tags">ROAS</div>
                <div className="what-tags">CAC</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Scale organic and lifecycle growth with SEO, content strategy,
                email automation, and conversion-focused user journey design.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">SEO</div>
                <div className="what-tags">Content Clusters</div>
